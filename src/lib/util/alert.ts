...
const infoTheme = {
    "--toastBackground": "oklch(var(--in) / 0.1)",
    "--toastColor": "oklch(var(--in) / 1)",
    "--toastBorderRadius": "var(--rounded-box)",
    "--toastBarBackground": "oklch(var(--in) / 1)",
}
...
const warningTheme = {
    "--toastBackground": "oklch(var(--wa) / 0.1)",
    "--toastColor": "oklch(var(--wa) / 1)",
    "--toastBorderRadius": "var(--rounded-box)",
    "--toastBarBackground": "oklch(var(--wa) / 1)",
}
...
const dangerTheme = {
    "--toastBackground": "oklch(var(--er) / 0.1)",
    "--toastColor": "oklch(var(--er) / 1)",
    "--toastBorderRadius": "var(--rounded-box)",
    "--toastBarBackground": "oklch(var(--er) / 1)",
}
...
export const info = (message: string) => {
    toast.push(`<div class="flex place-items-center">${infoIcn}<div>${message}</div></div>`, { theme: infoTheme })
}

export const warning = (message: string) => {
    toast.push(`<div class="flex place-items-center">${warningIcn}<div>${message}</div></div>`, { theme: warningTheme })
}

export const danger = (message: string) => {
    toast.push(`<div class="flex place-items-center">${dangerIcn}<div>${message}</div></div>`, { theme: dangerTheme })
}
